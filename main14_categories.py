...
def analyze_youtube_workout(youtube_url, cache_dir='cache_14', force_refresh=False):
    """
...
from main14_prompt_and_schema import create_classification_prompt, RESPONSE_FORMAT

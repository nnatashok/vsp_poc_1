...
def analyze_youtube_workout(youtube_url, cache_dir='cache_15', force_refresh=False):
    """
...
from main15_vibes_and_schema import create_classification_prompt, RESPONSE_FORMAT

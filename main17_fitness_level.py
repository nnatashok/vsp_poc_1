...
from main17_prompt_and_schema import CLASSIFICATION_PROMPT, RESPONSE_FORMAT, USER_PROMPT


def analyze_youtube_workout(youtube_url, cache_dir='cache_17', force_refresh=False):
    """

...
5. For each workout, identify 1-3 most suitable vibes that match the workout.
6. For each vibe, assign a prominence value (0-1) indicating how strongly this vibe is represented in the workout.
7. For each vibe, assign a confidence value (0-1) indicating how confident you are in this classification.
8. Provide a detailed explanation of why you assigned specific vibes, citing evidence from the metadata.
...
3. Justifies the prominence and confidence values assigned to each vibe
...
RESPONSE_FORMAT = {
    ...
    "json_schema": {
        ...
        "schema": {  # Schema is wrapped in a schema field
            ...
            "properties": {
                "vibes": {
                    ...
                    "items": {
                        ...
                        "required": ["name", "prominence", "confidence"]
                    },
                    "minItems": 1,
                    "maxItems": 3
                },
            ...
            "required": ["vibes", "vibesExplanation"],

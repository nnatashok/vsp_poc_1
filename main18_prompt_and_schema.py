...
CLASSIFICATION_PROMPT = """You are a specialized AI fitness equipment analyst. Your task is to analyze YouTube workout video metadata and identify what equipment is needed to perform the workout effectively.
...
USER_PROMPT = "Analyze this workout video metadata and identify what equipment is needed according to the schema:"

# Updated JSON schema for classification of required equipment
RESPONSE_FORMAT = {
    "type": "json_schema",
    "json_schema": {

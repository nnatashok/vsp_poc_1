# Classification prompt as a simple text variable instead of a function
CLASSIFICATION_PROMPT = """You are a specialized AI fitness analyst. Your task is to analyze YouTube workout video metadata and classify the workout based on three key metrics:
...
USER_PROMPT = "Analyze this workout video metadata and classify its technique difficulty, effort difficulty, and required fitness level according to the schema:"

# Updated JSON schema for classification of technique difficulty, effort difficulty, and required fitness level
RESPONSE_FORMAT = {
    "type": "json_schema",
    "json_schema": {

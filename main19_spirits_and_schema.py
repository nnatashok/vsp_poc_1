...
# Updated JSON schema for strict validation of the response with the new spirits structure
RESPONSE_FORMAT = {
    "type": "json_schema",
    "json_schema": {
        "name": "WorkoutSpiritAnalysis",  # Required name field for json_schema
